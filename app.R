  ...
  output$numIter6 <- renderUI(
  {
    ...
    if ((input$replyMethod6=="Bootstrap clustering") | (input$replyMethod6=="Noise clustering"))
    {
      tagList(
        ...
        bsModal ("modNumIter6", "Number of iterations", "butNumIter6", size = "large", "Dit is de helptekst"),
      
        HTML("<span style='font-weight: bold;'>&nbsp;Number of iterations:</span>"),
        div(style='height: 12px'),
        div(style='margin-left: 60px', numericInput(
          inputId = "numIter6",
          label   = NULL,
...
options(shiny.maxRequestSize=Inf) # 100*1024^2
